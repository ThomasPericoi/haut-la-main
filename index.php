...
elseif (is_tag()) :
    $title = single_tag_title(__('Tag : ', 'haut-la-main'), false);
    ...
    <div class="container formatted">
        ...
        if (!empty($categories_html)) : ?>
            <div class="btn-wrapper">
                <?= __('Catégories :', 'haut-la-main') . $categories_html; ?>
            </div>
        <?php endif; ?>
    </div>
</section>
...
<section id="index-loop-<?= uniqid(); ?>" class="index-loop">
    <div class="container">
        ...
        <div class="posts-wrapper">
            ...
            <?php else : echo __('Aucun article n\'a été (encore) publié ici.', 'haut-la-main');
            endif; ?>
            <?php the_posts_pagination(array(
                'prev_text' => __('<span class="icon icon-left"></span>', 'haut-la-main'),
                'next_text' => __('<span class="icon icon-right"></span>', 'haut-la-main'),
            )); ?>
        </div>
    </div>
</section>
